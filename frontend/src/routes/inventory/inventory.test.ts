...
describe('inventory page', () => {
	beforeEach(() => vi.spyOn(globalThis, 'fetch').mockResolvedValue(new Response(JSON.stringify({ total_quantity: 9, warnings: [], items: [
		{ part_num: '3001', part_name: 'Brick 2 x 4', color_id: 4, color_name: 'Bright Red', rgb_hex: 'C91A09', quantity: 5, image_url: 'https://example.com/brick.png', source_set_nums: ['10497-1'] },
		{ part_num: '3001', part_name: 'Brick 2 x 4', color_id: 85, color_name: 'Dark Bluish Gray', rgb_hex: '6C6E68', quantity: 4, image_url: 'https://example.com/brick.png', source_set_nums: ['31109-1'] }
	...
	it('shows a part thumbnail for inventory rows', async () => {
		render(InventoryPage);
